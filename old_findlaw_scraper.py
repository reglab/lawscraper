    ...
    def _goto_with_retry(page: Page, url: str, attempts: int = 3) -> bool:
        ...
        for i in range(attempts):
            try:
                ...
                # Wait for accordion container or test id to appear as a page-readiness signal
                page.wait_for_selector('[data-testid="fl-accordion"], .fl-expandable-tree-accordion-container', timeout=20000)
                return True
